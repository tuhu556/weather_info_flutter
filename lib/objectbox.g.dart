...
import 'features/weather_info/domain/entities/weather_local_info_response_entity/main_weather_info_local_enity.dart';
...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 4760719127894602273),
      name: 'CloudsLocalEntity',
      lastPropertyId: const obx_int.IdUid(2, 7136357387312211575),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 1075024478840666055),
            name: 'all',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 7136357387312211575),
            name: 'id',
            type: 6,
            flags: 1)
      ],
  ...
  obx_int.ModelEntity(
      id: const obx_int.IdUid(2, 95526954172417232),
      name: 'CoordinateLocalEntity',
      lastPropertyId: const obx_int.IdUid(3, 7599027406078077295),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5817583287865384329),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3457118170568526762),
            name: 'lon',
            type: 8,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 7599027406078077295),
            name: 'lat',
            type: 8,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(3, 4026403846409799046),
      name: 'MainWeatherInfoLocalEntity',
      lastPropertyId: const obx_int.IdUid(7, 6453491766523646109),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 7173179199626038661),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 6978170404275663406),
            name: 'temp',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 6683058083477237195),
            name: 'feelsLike',
            type: 8,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 8834070232703928337),
            name: 'tempMin',
            type: 8,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 4490650866632249425),
            name: 'tempMax',
            type: 8,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(6, 1722825357298173695),
            name: 'pressure',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 6453491766523646109),
            name: 'humidity',
            type: 6,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(4, 3898969689511728573),
      name: 'SunsetSunriseLocalEntity',
      lastPropertyId: const obx_int.IdUid(5, 8324982418341284153),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 9062205022001531498),
            name: 'type',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 6460716692957462031),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8344169041646745778),
            name: 'country',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4923176770012890811),
            name: 'sunrise',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 8324982418341284153),
            name: 'sunset',
            type: 9,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(5, 6049057663634723149),
      name: 'WeatherDescriptionLocalEntity',
      lastPropertyId: const obx_int.IdUid(4, 5422769363941982713),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 3368748297606207610),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 6806362376400492134),
            name: 'main',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 6427527180152777124),
            name: 'description',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 5422769363941982713),
            name: 'icon',
            type: 9,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(6, 6161239682339593053),
      name: 'WeatherInfoLocalEntity',
      lastPropertyId: const obx_int.IdUid(10, 4403343633691724192),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8116388709575124582),
            name: 'mainId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(1, 4005190121242066256),
            relationTarget: 'MainWeatherInfoLocalEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3456670482868581067),
            name: 'visibility',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 5802885492412647663),
            name: 'windId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(2, 4690994899266303493),
            relationTarget: 'WindInfoLocalEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4342670134271656028),
            name: 'cloudsId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(3, 2731473470689054668),
            relationTarget: 'CloudsLocalEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 8726590280126522339),
            name: 'dt',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(6, 8557033476829005254),
            name: 'sysId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(4, 1209507008474406647),
            relationTarget: 'SunsetSunriseLocalEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 8867014913236129772),
            name: 'timezone',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(8, 4506288134704051527),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(9, 8947039649146338852),
            name: 'name',
            type: 9,
            flags: 34848,
            indexId: const obx_int.IdUid(5, 7616949942690496223)),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(10, 4403343633691724192),
            name: 'weatherThemeId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(6, 2697246147002780667),
            relationTarget: 'WeatherThemeLocalEntity')
      ],
      relations: <obx_int.ModelRelation>[
        obx_int.ModelRelation(
            id: const obx_int.IdUid(1, 2936077762283693045),
            name: 'weather',
            targetId: const obx_int.IdUid(5, 6049057663634723149))
      ],
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(7, 8725060040956913067),
      name: 'WindInfoLocalEntity',
      lastPropertyId: const obx_int.IdUid(3, 8720283949918096156),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8990956428120394253),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4471932053715964729),
            name: 'speed',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8720283949918096156),
            name: 'deg',
            type: 6,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(8, 7366152572353453761),
      name: 'WeatherThemeLocalEntity',
      lastPropertyId: const obx_int.IdUid(3, 5773954884096402255),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 9160895002827862066),
            name: 'firstColorHex',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3021929119203567010),
            name: 'secondColorHex',
            type: 6,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 5773954884096402255),
            name: 'id',
            type: 6,
            flags: 1)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(8, 7366152572353453761),
      lastIndexId: const obx_int.IdUid(6, 2697246147002780667),
      lastRelationId: const obx_int.IdUid(1, 2936077762283693045),
...
class WindInfoLocalEntity_ {
  ...
  static final id =
      obx.QueryIntegerProperty<WindInfoLocalEntity>(_entities[6].properties[0]);

  /// see [WindInfoLocalEntity.speed]
  static final speed =
      obx.QueryStringProperty<WindInfoLocalEntity>(_entities[6].properties[1]);

  /// see [WindInfoLocalEntity.deg]
  static final deg =
      obx.QueryIntegerProperty<WindInfoLocalEntity>(_entities[6].properties[2]);
}
